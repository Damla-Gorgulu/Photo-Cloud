...
public class ImageSecretary {
	 ...
	 * @return
	 */
	public static boolean writeFilteredImageToResources(ImageMatrix image, String path) {
		return writeImageToResources(image.getBufferedImage(), path);
	}
	 ...
	 * @return
	 */
	private static boolean writeImageToResources(RenderedImage image, String path) {
		boolean result = true;
		try {
